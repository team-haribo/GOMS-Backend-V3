package com.teamharibo.goms.domain.member.repository
...
interface MemberRepository : JpaRepository<Member, Long> {
    ...
    @Query(
        ...
        ORDER BY
            m.grade ASC,
            CASE
                WHEN m.department = com.teamharibo.goms.domain.common.enums.Department.SW  THEN 0
                WHEN m.department = com.teamharibo.goms.domain.common.enums.Department.IOT THEN 1
                ELSE 2
            END,
            m.name ASC
        """
    ...
    @Query(
        """
        UPDATE Member m
        SET m.role = com.teamharibo.goms.domain.common.enums.Role.ROLE_STUDENT
        WHERE m.role = com.teamharibo.goms.domain.common.enums.Role.ROLE_STUDENT_COUNCIL
